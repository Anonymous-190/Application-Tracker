        ...
        <>
          ...
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 ml-2">
              ...
              <Button onClick={() => onDelete(company.id)} variant="ghost" size="icon" className="h-8 w-8 hover:bg-destructive/10 hover:text-destructive rounded-lg">
          ...
          <div className="space-y-4">
            {/* ...existing display of website and LinkedIn... */}
